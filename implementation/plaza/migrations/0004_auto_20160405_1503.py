# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-04-05 15:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='plaza.Post')),
            ],
        ),
        migrations.CreateModel(
            name='Resource',
